...
We wanted the program to write particle code as accessible as possible; you can change any aspect of it - if you think its slow, messy or isn't to your liking - you can modify it to meet your standards. We will also be providing another document in the future for those who wants all the syntax and keywords for the language - to help you learn it; or for some, to help make a new transpiler - particle is really just a concept, anyone can make anything for and with particle.
